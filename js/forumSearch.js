...
var forumData = [
    ...
    {'name': 'Gabby H.', 'Question': ['What are the must have knives?'], 'link':'forumAnswers1.html', 'keyword': ['knives', 'knife', 'must'], 'email': 'gabby@gmail.com', 'profile': 'ProfileGabbyH.html'},
    {'name': 'Joe C.', 'Question': ['What are some good egg free recipes?'], 'link':'forumAnswers1.html', 'keyword': ['egg', 'free','recipes', 'recipe'], 'email': 'joe@gmail.com', 'profile': 'ProfileJoeC.html'},
    {'name': 'Jenny R.', 'Question': ['How to cook pasta.'], 'link':'forumAnswers1.html', 'keyword': ['pasta'], 'email': 'jenny@gmail.com', 'profile': 'ProfileJennyR.html'},
    {'name': 'Tammy B.', 'Question': ['What are some good gluten free banana bread recipes?'], 'link':'forumAnswers1.html', 'keyword': ['gluten', 'free', 'banana', 'bread', 'recipe'], 'email': 'tammy@gmail.com', 'profile': 'ProfileTammyB.html'},
    {'name': 'Darren T.', 'Question': ['Does anyone have a vegetarian jambalaya recipe?'], 'link':'forumAnswers1.html', 'keyword': ['vegetarian', 'jambalaya', 'recipe'], 'email': 'darren@gmail.com', 'profile': 'ProfileDarrenT.html'},
    {'name': 'Tom W.', 'Question': ['Tips for doubling a recipe?'], 'link':'forumAnswers1.html', 'keyword': ['tips', 'doubling', 'double', 'recipe'], 'email': 'tom@gmail.com', 'profile': 'ProfileTomW.html'},
